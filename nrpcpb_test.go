...
func (*DummyMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_nrpc_test_ece33dd17f931346, []int{0}
}
...
func init() { proto.RegisterFile("nrpc_test.proto", fileDescriptor_nrpc_test_ece33dd17f931346) }

var fileDescriptor_nrpc_test_ece33dd17f931346 = []byte{
