// This code was autogenerated from nrpc/examples/alloptions/alloptions.proto, do not edit.
package main
...
func (c *SvcCustomSubjectClient) MtStreamedReply(
	...
	sub, err := nrpc.StreamCall(ctx, c.nc, subject, &req, c.Encoding, c.Timeout, c.jsonMarshalOptions)
	if err != nil {
		return err
	}
...
func (c *SvcCustomSubjectClient) MtVoidReqStreamedReply(
	...
	sub, err := nrpc.StreamCall(ctx, c.nc, subject, &nrpc.Void{}, c.Encoding, c.Timeout, c.jsonMarshalOptions)
	if err != nil {
		return err
	}
